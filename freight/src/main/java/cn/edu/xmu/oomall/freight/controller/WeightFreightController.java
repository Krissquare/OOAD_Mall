...
public class WeightFreightController {
    ...
    public Object updateWeightItems(@RequestBody WeightFreightVo weightFreightVo, @PathVariable("shopId") Integer shopId, @PathVariable("id") Long id, Long userId, String userName) {
